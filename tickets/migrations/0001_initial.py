    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phonenumber', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '0899999999'. Up to 16 digits allowed.", regex='^\\0?1?\\d{9,16}$')], verbose_name='Mobile Number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_used_timestamp', models.IntegerField(default=0)),
